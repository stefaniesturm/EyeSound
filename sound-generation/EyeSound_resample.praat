...
# and save *WAV* files with the new rate to another directory.
...
form Change sample rate in sound files
   ...
   text input_directory  /home/stefanie/GitHub/EyeSound/sounds/
   comment Directory path of resampled files (old files will be overwritten!):
   text output_directory  /home/stefanie/GitHub/EyeSound/sounds2/
   optionmenu Output_format: 1
   option WAV
   positive New_sample_rate_(Hz) 96000
